...
CONFIG( debug, debug|release ) {
  ...
  DEFINES  *= QSAFEPRINTER_DEBUG
} else {
  #Release
  message( Building in RELEASE )
  DEFINES   *= QSAFEPRINTER_RELEASE
}
...
QMAKE_TARGET_COMPANY       = "Technoserv Team"
QMAKE_TARGET_PRODUCT       = $${TARGET}
QMAKE_TARGET_DESCRIPTION   = "Slant's work"
QMAKE_TARGET_COPYRIGHT     = "Copyright (C) 2009 Techoserv"
PACKAGE_DOMAIN             = "http://code.google.com/p/qsafeprinter"
